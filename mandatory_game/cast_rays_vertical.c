...
/*   Updated: 2021/04/01 00:35:00 by gleal            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "start_game.h"
/* Vertical casting is different if the player is left or right because we need to check if a particular wall intersection is a hit or not.
But because these wall hits are located on the perifery of the wall we need to add or subtract 1 to the x position to make sure that is is inside the wall*/
